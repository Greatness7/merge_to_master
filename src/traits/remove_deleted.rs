...
bitflags::bitflags! {
    ...
    struct DeletionFlags: u8 {
        const HEADER = 1;
        const GAME_SETTING = 2;
        const GLOBAL_VARIABLE = 3;
        const CLASS = 4;
        const FACTION = 5;
        const RACE = 6;
        const SOUND = 7;
        const SOUND_GEN = 8;
        const SKILL = 9;
        const MAGIC_EFFECT = 10;
        const SCRIPT = 11;
        const REGION = 12;
        const BIRTHSIGN = 13;
        const START_SCRIPT = 14;
        const LANDSCAPE_TEXTURE = 15;
        const SPELL = 16;
        const STATIC = 17;
        const DOOR = 18;
        const MISC_ITEM = 19;
        ...
        const BOOK = 35;
        const ALCHEMY = 36;
        const LEVELED_ITEM = 37;
        const LEVELED_CREATURE = 38;
        const CELL = 39;
        const LANDSCAPE = 40;
        const PATH_GRID = 41;
        const DIALOGUE = 42;
        const DIALOGUE_INFO = 43;
